<header>
    <div class="navbar">
      ...
      <div class="nav">
        ...
        <ul>
          <li><a class="underline" href="enseignements.php"><i class="fa-light fa-cubes"> </i> Enseignements</a></li>
          <li><a class="underline" href="projets.php"><i class="fa-light fa-rocket"> </i> Projets étudiant</a></li>
          <li><a class="underline" href="internationale.php"><i class="fa-light fa-graduation-cap"> </i> Internationale</a></li>
          <li><a class="underline" href="temoignages.php"><i class="fa-light fa-comment-lines"> </i> Témoignages</a></li>
          <li><a class="underline" href="jpo.php"><i class="fa-light fa-magnifying-glass-arrow-right"> </i> JPO</a></li>
        </ul>
    </div>
      ...
      <div class="sidenav" id="sideNav">
        ...
        <div class="sidenavheader">
          ...
          <a href="#" id="btnClose" class="close"><i class="fa-solid fa-xmark"></i></i></a>
        </div>

        <ul>
          <li><a href="enseignements.php"><i class="fa-light fa-cubes"> </i> Enseignements</a></li>
          <li><a href="projets.php"><i class="fa-light fa-rocket"> </i> Projets étudiant</a></li>
          <li><a href="internationale.php"><i class="fa-light fa-graduation-cap"> </i> Internationale</a></li>
          <li><a href="temoignages.php"><i class="fa-light fa-comment-lines"> </i> Témoignages</a></li>
          <li><a href="jpo.php"><i class="fa-light fa-magnifying-glass-arrow-right"> </i> JPO</a></li>
        </ul>

        <div class="social-icons">
          <div class="d-flex-column">

            <h2 class="colorgrad">BUT MMI</h2>
            <p>IUT de Champs-sur-Marne<br>2, rue Albert Einstein<br>
              77420 Champs-sur-Marne</p>
          </div>
          <div>
            <div class="social-icon"><a href="https://twitter.com/MMI_Champs"><i class="fa-brands fa-twitter"></i></a></div>
            <div class="social-icon"><a href="https://www.instagram.com/mmi_champs/"><i class="fa-brands fa-instagram"></i></a></div>
          </div>
        </div>
