...
<html lang="fr">
  ...
  <body>
        ...
        <div class="sidenav" id="sideNav">
         ...
         <g>
          ...
          <ul>
            ...
            <li><a href="#">Projets étudiant</a></li>
            <li><a href="#">Internationale</a></li>
            <li><a href="#">Témoignages</a></li>
            <li><a href="#">C'est quoi MMI ?</a></li>
          </ul>
    ...
    <main class="page-module d-flex-column">


      <div class="d-flex-column">
        <h1>INFORMATIQUE</h1>

        <div class="d-flex-row sujet">
      ...
      <img src="" alt="Nouvelle image">
          <h2>Objectifs :</h2>
          <ul>
            <li>Etre capable de développer un site web ou une application (Javascript, PHP et SQL)</li>
            <li>Maîtriser l’intégration web ( HTML, CSS, ergonomie).</li>
            <li>Configurer et gérer des systèmes de gestions de contenus (CMS, Blog, ...).</li>
          </ul>

          <img src="" alt="Nouvelle image">

          <p>Le module d'informatique de la formation BUT MMI se concentre sur les compétences informatiques de base nécessaires pour travailler dans le domaine des médias et de l'Internet, notamment la programmation, la conception de sites web, la création de graphiques et de contenu multimédia, ainsi que l'utilisation de logiciels de gestion de projet.</p>

          <div class="d-flex-row btn-module">
            <div class="d-flex-column btn-icon">
              <a href="enseignements.html"><i class="fa-solid fa-home"></i></a>
              <p>Retourner au enseignements</p>
            </div>
            <div class="d-flex-column btn-icon">
              <a href="module-culture-artistique.html">
                <i class="fa-brands fa-unity"></i></a>
                <p>Module suivant</p>
            </div>
          </div>
    </main>
